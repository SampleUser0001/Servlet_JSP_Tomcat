...
public enum OptionsEnum01 {
    ...
    public static List<PulldownOptionModel> getPulldownOptionModels(Object selectedValue) {
        List<PulldownOptionModel> options = new ArrayList<>();
        for (OptionsEnum01 option : OptionsEnum01.values()) {
            boolean isSelected = String.valueOf(option.getValue()).equals(String.valueOf(selectedValue));
