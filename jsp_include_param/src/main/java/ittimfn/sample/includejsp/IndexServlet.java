...
public class IndexServlet extends HttpServlet {
    ...
    private void setAttributesOptions01(HttpServletRequest request) {
        ...
        PulldownModel sample01 = new PulldownModel(
            ...
            OptionsEnum01.getPulldownOptionModels(selectedValue)
        );

        request.setAttribute(OptionsEnum01.SELECT_ID, sample01);
    }
    ...
    private void setAttributesOptions02(HttpServletRequest request) {
        ...
        PulldownModel sample02 = new PulldownModel(
            ...
            OptionsEnum02.getPulldownOptionModels(selectedValue)
        );

        request.setAttribute(OptionsEnum02.SELECT_ID, sample02);
    }
